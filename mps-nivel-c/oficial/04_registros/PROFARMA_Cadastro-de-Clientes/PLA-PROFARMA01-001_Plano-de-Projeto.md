...
**Implementação prática:** dos 16 MRs do repositório, 11 com 1 revisor (~69%) e 5 com 2 revisores (~31%) — estes últimos correlacionados com mudanças de integração, configuração e release. Em 100% dos MRs o revisor é distinto do autor (segregação de aprovação), e o merge é executado por quem não é o autor.
