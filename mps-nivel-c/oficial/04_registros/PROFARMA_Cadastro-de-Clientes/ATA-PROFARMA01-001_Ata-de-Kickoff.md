...
| D-02 | Banco de dados PostgreSQL no Azure (não SQL Server) | Tiago Nascimento (Timeware) | Confirmado no kickoff |
...
| D-08 | Mudanças arquiteturais precisam da aprovação de Armando Junior (D1000) antes da implementação | Tiago Nascimento (Timeware) | Vigente durante todo o projeto |
...
| Apresentar primeiro Sprint Planning em 28/04/2025 | Tiago Nascimento / Erick Coelho | 28/04/2025 |
