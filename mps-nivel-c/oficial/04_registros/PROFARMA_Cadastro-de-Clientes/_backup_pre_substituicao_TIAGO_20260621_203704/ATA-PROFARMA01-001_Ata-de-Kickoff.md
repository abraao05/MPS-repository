...
A Timeware apresentou a equipe completa ao time D1000. Ficou estabelecido que Tiago Barbosa Nascimento (Timeware) e Armando Junior (D1000) seriam os pontos técnicos primários de cada lado, com Abraão Oliveira como ponto de gestão e Helena Moreira como coordenadora D1000. Humberto Erler participaria das reuniões executivas de status.
...
| D-02 | Banco de dados PostgreSQL no Azure (não SQL Server) | Tiago Barbosa Nascimento (Timeware) | Confirmado no kickoff |
...
| D-08 | Mudanças arquiteturais precisam da aprovação de Armando Junior (D1000) antes da implementação | Tiago Barbosa Nascimento (Timeware) | Vigente durante todo o projeto |
...
| Apresentar primeiro Sprint Planning em 28/04/2025 | Tiago Barbosa Nascimento / Erick Coelho | 28/04/2025 |
