...
- Testes unitarios realizados durante o desenvolvimento (nível de método e classe)
...
|---|---|---|
| Cobertura de testes unitarios | >= 60% nas camadas de serviço e repositório | REQ RNF-05 (REQ-AASP01-001) |
...
2. Build sem erros + todos os testes unitarios passando
...
1. Todos os testes unitarios passando; cobertura conforme meta do projeto
