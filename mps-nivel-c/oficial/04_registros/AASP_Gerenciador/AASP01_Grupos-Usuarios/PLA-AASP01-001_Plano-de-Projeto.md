...
|----------|-----------------------|------|------------------------------------------------------------------|----------------|
| Sprint 1 | 26/05/2026–06/06/2026 | 34   | CRUD grupos (RF-01 a RF-04), Permissões RBAC (RF-05), Vínculos (RF-06) — PRs #11–#15 | ✅ Concluída — aceite Marcos Ferreira 06/06/2026 |
...
|------------------------------|------------------|-------------|----------------------------------------------------------------------------------------------|
| Product Owner                | Marcos Ferreira  | AASP        | Priorização do backlog, aceite de entrega, aprovação de change requests                      |
| QA / Homologação             | Renata Souza     | AASP        | Execução de testes de homologação, emissão de parecer de aceite por sprint                   |
| Gerente de Projeto / Tech Lead | Henry Komatsu  | Timeware    | Coordenação do projeto, arquitetura técnica, code review, relatório de status, gestão de riscos |
| Desenvolvedor Junior         | Bruno Almeida    | Timeware    | Implementação das features, testes unitários, atualização da documentação técnica            |

## 5. Plano de Comunicação

| Evento                  | Frequência                              | Canal          | Participantes              | Responsável    |
|-------------------------|-----------------------------------------|----------------|----------------------------|----------------|
| Daily Stand-up          | Diária — 09h30                          | Microsoft Teams | Equipe Timeware            | Henry Komatsu  |
| Sprint Review           | Sexta-feira da semana de fechamento     | Microsoft Teams | Equipe completa + PO + QA  | Henry Komatsu  |
| Sprint Retrospectiva    | Sexta-feira da semana de fechamento     | Microsoft Teams | Equipe Timeware            | Henry Komatsu  |
| Relatório de Status     | Semanal — toda segunda-feira            | E-mail         | Marcos Ferreira, Renata Souza | Henry Komatsu |
...
|-----------------------------|--------------------|-------------------|--------------------------------------------------------------|
| Testes unitários            | A cada sprint      | Bruno Almeida     | Cobertura ≥ 70% nos módulos entregues na sprint              |
| Code review                 | A cada PR          | Henry Komatsu     | Aprovação formal no Azure DevOps antes do merge              |
| Testes de integração        | Sprint 2           | Henry Komatsu     | Endpoints integrados validados em ambiente de desenvolvimento |
| Homologação QA              | Sprint 3 e Sprint 4 | Renata Souza     | Parecer de aceite emitido pela QA da AASP                    |
| Aceite formal               | Fim de cada sprint  | Marcos Ferreira  | Confirmação escrita do PO (e-mail ou Teams)                  |
...
2. Ser avaliada pelo Gerente de Projeto (Henry Komatsu) quanto a impacto em prazo, esforço e riscos
3. Ser aprovada formalmente por **Marcos Ferreira (AASP)** e **Henry Komatsu (Timeware)**
