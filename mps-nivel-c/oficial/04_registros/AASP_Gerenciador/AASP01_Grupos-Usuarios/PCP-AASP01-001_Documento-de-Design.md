...
|---|---|---|---|
| 1.0 | 26/05/2026 | Henry Komatsu | Arquitetura inicial — Sprint 1; stack, modelo de dados, endpoints S1 |
| 1.1 | 15/06/2026 | Henry Komatsu | Adicao da secao 6 (integracao ms.temis.vinculos) apos disponibilizacao do contrato de API no inicio da Sprint 2 |
