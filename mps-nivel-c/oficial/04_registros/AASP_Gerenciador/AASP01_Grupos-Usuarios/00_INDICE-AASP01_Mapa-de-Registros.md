...
- **Status atual (01/07/2026):** em execução — Sprints 1 e 2 concluídas e aceitas (06/06/2026 e 20/06/2026); Sprint 3 em andamento desde 23/06/2026.
...
| 18 | GQA-AASP01-001 | Registro de Verificação de GQA | GQA | ✅ |
...
| 1.2 | 01/07/2026 | Silvio Baroni (SEPG) | Correção de NCs de auditoria: status atualizado para Sprint 3 em andamento; processo GPC → GQA (linha 18); datas e contagem de sprints corrigidas. |
