...
- **Testes do QA (Jonathan, a partir da Fase 4):** validação dos 12 cenários funcionais (CT-01 a CT-12), edge cases e regressão após correção dos defeitos BUG-01 a BUG-05.
...
Os resultados dos testes são analisados pelo QA (Jonathan) e comunicados ao Gerente de Projeto (Abraão Oliveira) durante as reuniões de revisão registradas nas atas ATA-AASPGOV01-001 a ATA-AASPGOV01-003. Defeitos identificados são registrados com ID, descrição, fase e tratamento no REL-VV-AASPGOV01-001 e acompanhados até resolução. Os indicadores de qualidade (taxa de aprovação de cenários, contagem e severidade de defeitos, e status dos critérios de aceite) alimentam o documento de Medição `MED-AASPGOV01-001`. A validação final dos critérios de aceite CA01–CA07 pelo Sponsor Marcos Correa Fernandez Turnes foi registrada na ATA-AASPGOV01-003 (29/05/2026) e formalizada no TAE-AASPGOV01-001 (02/06/2026).
...
| 1.1 | 15/06/2026 | Time de Melhoria Contínua | Responsável pelos testes de QA atualizado: Jonathan substituiu Caroline Sousa. |
