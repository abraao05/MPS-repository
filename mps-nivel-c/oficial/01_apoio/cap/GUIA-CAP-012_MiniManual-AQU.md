...
**Por que fazer.** Aquisições sem processo formal criam ambiguidade nos dois lados: o fornecedor não sabe o que é exigido, e a Timeware não sabe como avaliar a entrega. O processo define os pontos de controle que protegem o resultado — dos requisitos ao aceite.

**Como usar no dia a dia.**
1. Identifique se o engajamento envolve aquisição de produto, serviço ou subcontratação (PRO-AQU-001 §1).
2. Defina os requisitos e critérios de aceite antes de contratar.
3. Selecione o fornecedor com base nos critérios definidos e registre a decisão.
4. Formalize o acordo (contrato, SOW, ordem de serviço) com escopo, prazo e critérios.
