...
**Por que fazer.** Construir sem design explícito leva a soluções que ninguém sabe por que existem e que ninguém consegue manter. Registrar alternativas e a justificativa da escolha evita refazer a mesma análise depois e protege contra "por que fizemos assim mesmo?".

**Como usar no dia a dia.**
1. Para cada solução relevante, registre o design, os requisitos que atende e as interfaces.
2. Antes de construir, considere alternativas e decida construir/comprar/reutilizar — com justificativa (seção 1.2). É obrigatório.
3. Avalie o design e trate os problemas antes de implementar (seção 2).
4. Implemente conforme o projetado e confirme a conformidade (seção 3).
