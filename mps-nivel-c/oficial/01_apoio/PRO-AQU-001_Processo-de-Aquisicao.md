# Processo de Aquisição — TIMEWARE
...
Este processo define como a Timeware conduz a **aquisição de produtos e serviços de software de terceiros** quando ela ocorre em um projeto — desde a definição de critérios e seleção do fornecedor até o monitoramento do acordo e a revisão técnica das entregas.

## 2. Aplicabilidade

A aquisição ocorre quando a Timeware **contrata um terceiro para entregar parte do produto ou do trabalho de um projeto**, com aquele terceiro respondendo pela entrega (por exemplo, subcontratação de desenvolvimento, componentes ou serviços técnicos que integram a entrega ao cliente).

**Não** são consideradas aquisição, para fins deste processo:

- aquisição de software de prateleira, licenças e serviços de infraestrutura/nuvem;
- contratação de profissionais que atuam **como parte da equipe da Timeware**, sob gestão da organização (tratados como recursos próprios, em GPR e CAP).
...
|---|---|
| **COO (Operações)** | Aprova a aquisição e o acordo com o fornecedor. |
| **Gerente de Projeto** | Conduz a seleção, o acordo e o monitoramento do fornecedor no projeto. |
| **Tech Lead / Arquiteto** | Define critérios técnicos; conduz a revisão técnica das entregas. |
| **Backoffice (Jurídico/Contratos)** | Apoia a formalização contratual do acordo. |
