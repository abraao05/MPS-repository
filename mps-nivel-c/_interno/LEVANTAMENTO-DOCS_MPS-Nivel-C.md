# Levantamento de Documentos — MPS-SW Nível C — Timeware
...
### Projeto FTGASMIG — Governança de APIs (GASMIG)

OS-001 encerrada (aceite 26/05/2026) · OS-002 em andamento

| Documento | Código | Versão | Situação |
|---|---|---|---|
| Termo de Abertura — OS-001 | TAP-GASMIG02-001 | 1.0 | ✅ Produzido |
| Plano de Projeto — OS-001 | PLA-GASMIG02-001 | 1.1 | ✅ Produzido |
| Documento de Requisitos — OS-001 | REQ-GASMIG02-001 | 1.0 | ✅ Produzido |
| Documento de Design — OS-001 | PCP-GASMIG02-001 | 1.1 | ✅ Produzido |
| Plano de V&V — OS-001 | VV-GASMIG02-001 | 1.0 | ✅ Produzido |
| Matriz de Rastreabilidade — OS-001 | RASTR-GASMIG02-001 | 1.0 | ✅ Produzido |
| Registro de Adaptação — OS-001 | ADAP-GASMIG02-001 | 1.2 | ✅ Produzido |
| Registro de Análise de Decisão | GDE-GASMIG02-001 | 1.0 | ✅ Produzido |
| Registro de Verificação Técnica — OS-001 | REV-GASMIG02-001 | 1.0 | ✅ Produzido |
| Ata de Kickoff | ATA-GASMIG02-001 | 1.0 | ✅ Produzido |
| Ata de Aceite — OS-001 | ATA-GASMIG02-002 | 1.0 | ✅ Produzido |
| Termo de Encerramento — OS-001 | TAE-GASMIG02-001 | 1.0 | ✅ Produzido |
| Lições Aprendidas | LI-GASMIG02-001 | 1.0 | ✅ Produzido |
| Registro de Capacitação da Equipe | CAP-GASMIG02-001 | 1.0 | ✅ Produzido |
| Registro de GQA | GQA-GASMIG02-001 | 1.2 | ✅ Produzido |
| Termo de Abertura — OS-002 | TAP-GASMIG02-002 | 1.0 | ✅ Produzido |
| Plano de Projeto — OS-002 | PLA-GASMIG02-002 | 1.1 | ✅ Produzido |
| Documento de Requisitos — OS-002 | REQ-GASMIG02-002 | 1.0 | ✅ Produzido |
| Documento de Design — OS-002 | PCP-GASMIG02-002 | 1.0 | ✅ Produzido |
| Plano de V&V — OS-002 | VV-GASMIG02-002 | 1.0 | ✅ Produzido |
| Matriz de Rastreabilidade — OS-002 | RASTR-GASMIG02-002 | 1.0 | ✅ Produzido |
| Registro de Adaptação — OS-002 | ADAP-GASMIG02-002 | 1.0 | ✅ Produzido |
| Registro de Verificação Técnica — OS-002 | REV-GASMIG02-002 | — | ⬜ Previsto para 09/06/2026 |
| Ata de Aceite — OS-002 | ATA-GASMIG02-003 | — | ⬜ Previsto para 10/06/2026 |
| Termo de Encerramento — OS-002 | TAE-GASMIG02-002 | — | ⬜ Previsto para 10/06/2026 |

### Demais projetos

| Projeto | Cliente | Situação |
|---|---|---|
